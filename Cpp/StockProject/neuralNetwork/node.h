...
public:
   ...
   void copyOver(node other);          //*********copies over "everything" from other into self
   string repr();          //*******Creates a string representation
   bool eval(string repr); //*******Evaluates a string representation
private:
   double outputVal;
   double outputLin;
