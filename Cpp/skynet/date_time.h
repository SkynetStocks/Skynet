...
public:
	...
	inline void setYear(int newY) { d.setYear(newY); }
	inline void setMonth(int newM) { d.setMonth(newM); }
	inline void setDay(int newD) { d.setDay(newD); }
	inline void setHour(int newH) { t.setHour(newH); }
	inline void setMinute(int newM) { t.setMinute(newM); }
	inline void setSecond(int newS) { t.setSecond(newS); }
